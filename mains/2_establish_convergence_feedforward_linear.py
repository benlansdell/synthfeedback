...
from models.npmodels import NPModel4_ExactLsq, NPModel4_ExactLsq_CorrectBatch, NPModel4_ExactLsq_Linear_CorrectBatch
...
def main():
    args = get_args()
    model_name = 'nodepert4_fixedw_exact_linear'
    Model = NPModel4_ExactLsq_Linear_CorrectBatch
